# Rabota.by Parser v2.0

Парсер вакансий с [rabota.by](https://rabota.by) для мониторинга рынка труда Беларуси. Собирает данные по **174 специализациям**, гармонизирует их и сохраняет в JSON для дальнейшего анализа и визуализации.
